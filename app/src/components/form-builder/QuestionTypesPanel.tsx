              ...
              {category.types.map((type) => {
                ...
                return (
                  <button
                    ...
                    className="group flex w-full items-center gap-3 rounded-lg border border-zinc-800 bg-zinc-900/60 px-3 py-3 text-left transition hover:border-zinc-700 hover:bg-zinc-900"
                  >
